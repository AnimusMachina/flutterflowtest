...
import 'event_name_model.dart';
export 'event_name_model.dart';
...
class _EventNameWidgetState extends State<EventNameWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventNameModel());
  }
